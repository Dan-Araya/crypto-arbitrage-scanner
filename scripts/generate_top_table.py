...
OUT_PATH = "assets/top_episodes.png"
DPI = 200
...
def render(fig, data, hl):
    ...
    right = 0.04
    top_pad = 0.03
    bot_pad = 0.10          # espacio para el caption (dos líneas)

    head_main_h = 0.050     # fila superior del header (más alta)
    head_sub_h = 0.038      # fila de subtítulos
    ...
    # ---- Filas de datos ----
    data_top = y_bot  # parte inferior del header = parte superior de los datos
    for di in range(N):
